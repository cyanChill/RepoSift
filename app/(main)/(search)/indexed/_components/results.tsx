...
export default function Results({ results }: Props) {
  ...
  return (
    <>
      ...
      <section className="fixed left-0 top-1/2 z-[110] h-min w-full min-w-0 -translate-y-1/2 md:sticky md:top-24 md:z-[90] md:h-[50vh] md:max-h-[50rem] md:translate-y-0">
